...
/**
 * Same public YouTube-direct embed HTML used for Settings preview
 * (must be served from http://localhost… so the API key HTTP referrer matches).
 */
...
function websiteEmbedDocument({ channelId, apiKey }) {
...
module.exports = { websiteEmbedDocument };
